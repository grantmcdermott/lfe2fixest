...
models. It does its best to ignoring any non-relevant arguments or adjust for
differing syntax options between `felm()` and `feols()`. The end goal is a 
converted R script that will produce the same output.
...
you use a modern table-generating package like **modelsummary**. The same will 
